...
| 13 | microsoft/llmail-inject-challenge | https://huggingface.co/datasets/microsoft/llmail-inject-challenge | mit | 영어 | ⭐**PI 전문(간접·이메일 주입)** · **198,009행**(실제 챌린지 제출 공격) · attack_attempt(True 148k/Unclear 38k/False 12k)·reason · 중복 0% · ⚠️원본 1.6GB→공격텍스트 추출본 `llmail_attacks_extracted.parquet`(40MB)만 보관 |
